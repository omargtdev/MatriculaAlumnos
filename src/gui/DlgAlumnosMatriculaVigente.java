...
public class DlgAlumnosMatriculaVigente extends JDialog implements WindowListener, ActionListener {
	...
	public DlgAlumnosMatriculaVigente() {
		...
		setBounds(100, 100, 710, 401);
		getContentPane().setLayout(null);
		setLocationRelativeTo(null);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 45, 674, 302);
